...
def manage_students():
    # Create a list named students containing at least three student names
    students = ['Jill', 'Jim', 'Bob', 'Ross']
...
def combine_foods():
    # Create a tuple named foods containing the same number of foods as there are names in the students list
    foods = ('noodles', 'sushi', 'steak', 'gnocci') 
    meal = ''
    for food in foods:
        meal += food
